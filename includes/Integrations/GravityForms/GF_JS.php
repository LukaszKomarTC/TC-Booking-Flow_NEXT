...
final class GF_JS {
	...
	private static function build_partner_override_js( int $form_id, array $partners, string $initial_code = '' ) : string {
		...
		return "window.tcBfPartnerMap = window.tcBfPartnerMap || {};\n"
			...
			. "          var partPrice = parseLocaleFloat((qs('#input_'+fid+'_137_2')||{}).value||0);\n"
			. "          var partMemberPrice = parseLocaleFloat((qs('#input_'+fid+'_138_2')||{}).value||0);\n"
			. "          var partTotal = partPrice + partMemberPrice;\n"
			. "          // Read rental prices (fields 139.2, 140.2, 141.2, 171.2)\n"
			. "          var rentalRoad = parseLocaleFloat((qs('#input_'+fid+'_139_2')||{}).value||0);\n"
			. "          var rentalMTB = parseLocaleFloat((qs('#input_'+fid+'_140_2')||{}).value||0);\n"
			. "          var rentalEMTB = parseLocaleFloat((qs('#input_'+fid+'_141_2')||{}).value||0);\n"
			. "          var rentalGravel = parseLocaleFloat((qs('#input_'+fid+'_171_2')||{}).value||0);\n"
