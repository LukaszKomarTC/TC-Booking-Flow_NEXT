...
final class GF_JS {
	...
	private static function build_partner_override_js( int $form_id, array $partners, string $initial_code = '' ) : string {
		...
		return "window.tcBfPartnerMap = window.tcBfPartnerMap || {};\n"
			...
			. "        changed = setValIfChanged(152,'',false) || changed;\n"
			. "        changed = setValIfChanged(161,'',false) || changed;\n"
			...
			. "        changed = setValIfChanged(152, fmtPct(data.discount||''),false) || changed;\n"
			. "        changed = setValIfChanged(161, fmtPct(data.commission||''),false) || changed;\n"
